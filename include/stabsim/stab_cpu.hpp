...
namespace NWQSim
{
    ...
    public:
        ...
        void rowsum(int h, int i)
        {
            ...
            if(rz_flag)
            {
                int rzsum = sum + 2*rz_r[h]+ 2*rz_r[i];
