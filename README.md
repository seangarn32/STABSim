...
### Note: Non-Clifford noise sources are decomposed into probabilistic stabilizer gates. Since the stabilizer decomposition has some negative coefficients, it requires quasiprobability sampling to converge exactly. Details on how this is done can be found in [Exact and Efficient Thermal Errors](https://arxiv.org/abs/2512.09189)


## Citation

Use of this repo can be cited with the follow,

@misc{garner2025stabsimparallelizedcliffordsimulator,
      title={STABSim: A Parallelized Clifford Simulator with Features Beyond Direct Simulation}, 
      author={Sean Garner and Chenxu Liu and Meng Wang and Samuel Stein and Ang Li},
      year={2025},
      eprint={2507.03092},
      archivePrefix={arXiv},
      primaryClass={quant-ph},
      url={https://arxiv.org/abs/2507.03092}, 
}
